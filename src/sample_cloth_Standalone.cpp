...
#include "../materials/texturedLit.inc"
};

const char* basecolor_f = "../textures/basecolor.png";
const char* metallic_f = "../textures/metallic.png";
const char* normal_f = "../textures/normal.png";
const char* roughness_f = "../textures/roughness.png";
const char* ao_f = "../textures/ao.png";

static const std::string model_f = "/Users/jian.liu/Tutorials/Filament/source/filament_offscreen/my_build/samples/generated/resources/suzanne.filamesh";
...
int main() {
    std::string iblDirectory = "/Users/jian.liu/Tutorials/Filament/source/filament_offscreen/my_build/samples/default_env/";
